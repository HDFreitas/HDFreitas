...
<p align="left"> 
  ...
  <br><br>
  Sou um desenvolvedor Full Stack com experiência na criação e manutenção de aplicações web robustas. Trabalho ativamente com <strong>PHP</strong> e <strong>Vue.js</strong>, além de desenvolver soluções utilizando <strong>Node.js</strong> e <strong>TypeScript</strong>.
  <br><br>
